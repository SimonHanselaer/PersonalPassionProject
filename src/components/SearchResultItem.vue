<template>
  ...
  >
    ...
    <img
      ...
      height="50"
      :src="computedConfig.images.base_url + computedConfig.images.poster_sizes[2] + data.poster_path"
    />
    <img
      v-if="data.media_type == 'person'"
      class="searchItemImage"
      height="50"
      :src="computedConfig.images.base_url + computedConfig.images.poster_sizes[2] + data.profile_path"
    />
  </article>
</template>
